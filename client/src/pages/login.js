...

                    {
                        authView === 'loginView' ? (
                            <>
                                ...
                                <Button style={{marginTop:12}} variant="light" onClick={() => {setAuthView("recoverView")}}>Forgot Password?</Button>
                        ...
                        :
                        authView ==='recoverView' ? (
                        <>
                            
                            <h3 style={{marginTop:15}}>type your new password</h3>
                            <Form>
                                    <Form.Group>
                                        <Form.Label>Email address</Form.Label>
                                        <Form.Control type="email" value={email} onChange={(e) => {setEmail(e.target.value)}} />
